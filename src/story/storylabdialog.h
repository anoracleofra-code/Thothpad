...
private:
    ...
    void reviewSelectedProposal(const QString &decision);
    ...
    void populateProposals(const QJsonArray &proposals);
    ...
    QTableWidget *m_proposalTable;
    QPushButton *m_proposalRefresh;
    QPushButton *m_proposalAccept;
    QPushButton *m_proposalReject;
    QPlainTextEdit *m_proposalOutput;
