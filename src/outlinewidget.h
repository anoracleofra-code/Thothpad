...
public:
    // Pacing buckets stored in PACING_BUCKET_ROLE per outline item:
    // 0 = neutral, 1 = slow/dense narration, 2 = dialogue-heavy.
    static const int PACING_BUCKET_ROLE;
    static const int PACING_NEUTRAL;
    static const int PACING_SLOW;
    static const int PACING_FAST;
