...
#include "editor/breathmapwidget.h"
...
private slots:
    ...
    void toggleReaderMode(bool checked);
...
private:
    ...
    HtmlPreview *htmlPreview = nullptr;
    FolderViewWidget *folderViewWidget = nullptr;
    ProseAwarenessWidget *proseAwarenessWidget = nullptr;
    ProseController *proseController = nullptr;
