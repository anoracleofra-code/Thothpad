...
public:
    ...
    /**
     * Returns a stable description of the formatting-relevant AST nodes at
     * each source line. Index zero is unused because cmark line numbers are
     * one-based.
     */
    QVector<quint64> lineSignatures() const;
